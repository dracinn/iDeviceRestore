...
/**
 * Small plist value model used by the restore/TSS path.
 *
 * The Android app intentionally keeps this independent from desktop libplist so BuildManifest
 * identities can be parsed and TSS requests can be serialized without native dependencies.
 */
